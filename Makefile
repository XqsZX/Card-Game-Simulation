...
CMPL_SRCS	= Suit.cpp Pinochle.cpp HoldEm.cpp Game.cpp PinochleGame.cpp HoldEmGame.cpp Uno.cpp lab3.cpp

#               Source files containing only template class method definitions
TMPL_SRCS	= Card_T.cpp CardSet.cpp Deck.cpp GoFishGame.cpp

#               Header (.h) files
HEADER_FILES    = Suit.h Card_T.h CardSet.h Deck.h Pinochle.h HoldEm.h Game.h PinochleGame.h HoldEmGame.h Uno.h GoFishGame.h
